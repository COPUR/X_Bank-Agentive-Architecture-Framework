...
- **C4 System Context**: [c4_context_v2.puml](c4_context_v2.puml)

![C4 Context Diagram](c4_context.svg)

- **C4 Container**: [c4_container_v2.puml](c4_container_v2.puml)

![C4 Container Diagram](c4_container.svg)

- **C4 Component (Agent 3)**: [c4_component_v2.puml](c4_component_v2.puml)

![C4 Component Diagram](c4_component.svg)

- **Temporal Workflow (Sequence)**: [sequence_temporal_workflow_v2.puml](sequence_temporal_workflow_v2.puml)

![Sequence Diagram](sequence_temporal_workflow_v2.svg)

- **Cognitive Circuit Breaker (State)**: [state_deterministic_fallback_v2.puml](state_deterministic_fallback_v2.puml)
