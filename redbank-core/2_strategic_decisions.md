Part 2: Strategic Decisions - RedBank Agentive-Architecture-Framework
...
2.2 ADR-002: Event-Driven Transaction SAGA Pattern
	•	Status: APPROVED
	...
	•	Decision: Implement the SAGA Orchestration Pattern managed via Apache Kafka (AWS MSK). All state changes are broadcast as events, with dedicated compensating rollbacks to maintain eventual consistency.
